...
NDiplomacy = {
	...
	MAX_DUCHIES_LEGALLY_HELD = 10,								-- Max duchies that a king or above can hold before vassals start getting angry
	MAX_ELECTOR_TITLES_LEGALLY_HELD = 1,						-- Max elector titles that a king or above can hold before vassals start getting angry
	TITULAR_TITLES_COUNT_TOWARDS_DUCHY_LIMIT = 0,				-- If set to 1 then titular duchy titles (duchy titles with no de-jure land) will count towards the maximum duchy titles held before vassals will get upset.
	...
	MAX_DIPLO_DISTANCE = 1700,									-- Most diplomacy is disallowed if two rulers are too distant
...
NCharacter = {
	...
	AGE_OF_ADULTHOOD_FEMALE = 12,					-- Female can rule at this age.
